"""
Pipeline Description: Train Model V1 for Stock Prediction

Usage:
    # Develop models with default settings
    python -m pipeline.train_models_v1
    
    # Process specific tickers
    python -m pipeline.train_models_v1 --tickers BBCA,BBRI,TLKM
"""
...
from trainModelsV1.main import process_single_ticker
from trainModelsV1.helper import _ensure_directories_exist
from prepareTechnicalIndicators.helper import get_all_technical_indicators


def main():
    parser = argparse.ArgumentParser(
        description="Pipeline Description: Train ML models v1 for stock prediction"
    )
    ...
    if all_metrics:
        ...
        for (label_type, window), metrics_dfs in all_metrics.items():
            ...
            filepath = f"data/stock/model_v1/performance/{camel_label}/{window}dd.csv"

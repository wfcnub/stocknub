...
def process_single_ticker(args_tuple):
    ...
    Args:
        args_tuple: Tuple containing (ticker, label_types, rolling_windows, model_versions)

    Returns:
        Tuple of (ticker, success, message, num_new_rows)
    """
    ticker, label_types, rolling_windows, model_versions = args_tuple
    ...
    try:
        ...
        save_path = paths.get_combined_forecasts_path(max_window, ticker)
